...
export function HomeBView() {
  ...
  return (
    <div className="w-full h-full font-Cairo text-white flex flex-col justify-start items-center border bg-gradient-to-bl from-[#05010E] via-[#160523] to-[#1D041F] animate-gradient ">
