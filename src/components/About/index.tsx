  ...
  return (
    <div className="">
      <div className="font-Cairo">
        ...
        <div className="mt-20">
          <h2 className="text-2xl">Diplômes & Dev Skills</h2>
          <div className=" w-full h-full rounded-3xl">
            <p className="text-xl font-light">
              GRETA LOGNES Técnico Assistência informática e redes, 2018 em Lognes (França){" "}
              <br />
              IRONHACK Full-stack web developer, 2022 em remote (Portugal)
            </p>
          </div>
          <h2 className="text-2xl mt-10">Hobbies & Tech Interests</h2>
          <div className="w-full h-full rounded-3xl ">
            <p className="text-xl font-light ">
